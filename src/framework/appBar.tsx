      ...
      <AppBar position='static'>
        <Toolbar>
          ...
          <Tooltip title='About' arrow>
            <IconButton onClick={() => setInfoBoxVisible(true)} color='inherit'>
              <InfoIcon />
            </IconButton>
          </Tooltip>
        </Toolbar>
      </AppBar>
      <StyledDialog onClose={() => setInfoBoxVisible(false)} open={infoBoxVisible}>
        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
          <h1 style={headerStyling}>About Spend-Sentinel</h1>
          <Tooltip title='Back to app' arrow>
            <IconButton onClick={() => setInfoBoxVisible(false)} color='inherit'>
              <ExitToAppIcon />
            </IconButton>
          </Tooltip>
        </div>
